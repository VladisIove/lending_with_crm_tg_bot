# Generated by Django 3.0.2 on 2020-01-11 10:03

from django.db import migrations, models
import django.utils.timezone
import user_permission.models
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permission_user', models.PositiveSmallIntegerField(choices=[(1, 'менеджер'), (2, 'поставщик'), (3, 'админ')], default=1)),
            ...
            managers=[
                ('objects', user_permission.models.UserManager()),
            ],
        ),
    ]
